...
function checkWords(aString){
  ...
  for(var word of words) {
    ...
    if (new RegExp(regex, "i").test(aString)) {
      UI.message("🤖 Have you considered using '" + word.use + "' instead of '" + word.insteadOf + "'❓");
      break;
    }
  }
}
